        ...
        <section className="overflow-hidden bg-gray-50 sm:grid sm:grid-cols-2 max-w-[90rem] m-auto">
            <div className="p-8 md:p-12 lg:px-16 lg:py-24">
                <div className="mx-auto max-w-xl text-start ltr:sm:text-left rtl:sm:text-right">
                    ...
                    <p className=" text-gray-500 my-4 md:mt-4 md:block"> At [Your Event Management Company Name], we are committed to creating culturally rich experiences that transcend boundaries and celebrate diversity. We believe that when people come together to celebrate their differences, they create a world that is more vibrant and united.</p>

                    <h3 className="hidden text-gray-500 my-4 md:mt-4 md:block">  Join us on a journey through the rich tapestry of cultures from around the world. Let&apos;s make your cultural celebration a breathtaking, unforgettable event.
